...
import { csSenarioDrawer } from "./define/senario-drawer.js";

var moduleContainer = document.querySelector("#page-modules") as HTMLElement;
var MainArticle = document.querySelector("#main-article") as HTMLElement;
...
window.addEventListener("beforeprint", function (event) {
    ...
    var content = document.querySelectorAll("senario-drawer") as NodeListOf<csSenarioDrawer>
